...
if(TensorFlow_FOUND)
  ...
  if(TF_FIND_VERSION_EXACT)
    ...
    set(_TensorFlow_KNOWN_VERSIONS ${TensorFlow_ADDITIONAL_VERSIONS}
        "1.9" "1.9.0" "1.10" "1.10.0" "1.11" "1.11.0" "1.12" "1.12.0" "1.13")
    set(_TensorFlow_TEST_VERSIONS)
...
macro(add_tensorflow_cpu_operation op_name)
  ...
  add_library(${op_name}_op SHARED kernels/${op_name}_kernel.cc ops/${op_name}.cc )
...
macro(add_tensorflow_gpu_operation op_name)
  ...
  set(kernel_file "${CMAKE_SOURCE_DIR}/kernels/${op_name}_kernel.cu")
